  ...
  const plannedContentTypes = [
    {
      ...
      target: 10,
      description: "Hands-on projects with resume bullet points",
    },
    {
    ...
    { name: "ML Concepts", target: 150, description: "ML theory questions" },
    {
      name: "ML Coding",
      target: 50,
    ...
    },
    {
      ...
      target: 30,
      description: "Common BQ questions with sample answers",
    },
    {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Track our progress in building comprehensive interview preparation
          content.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-500 mb-6">
            Our target content goals for a complete interview preparation
            platform:
          </p>
