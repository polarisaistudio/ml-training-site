        ...
        {showSourceFilter && (
          <div>
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              >
                All ({realCount + practiceCount})
              </button>
              <button
                onClick={() => updateFilter("source", "real")}
                className={`px-3 py-1.5 rounded-full text-sm font-medium transition ${
                  currentSource === "real"
              ...
              <button
                onClick={() => updateFilter("source", "practice")}
                className={`px-3 py-1.5 rounded-full text-sm font-medium transition ${
      ...
      {(currentDifficulty !== "all" ||
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-2 flex-wrap">
          ...
          {currentSource !== "all" && (
            ...
            >
              {currentSource === "real" ? "🎯 Real Interview" : "📚 Practice"}
              <button
                onClick={() => updateFilter("source", "all")}
          ...
          {currentDifficulty !== "all" && (
            <span
              className={`px-2 py-1 rounded-full text-xs font-medium ${getDifficultyStyle(currentDifficulty, false)} flex items-center gap-1`}
            >
              {currentDifficulty}
              <button
