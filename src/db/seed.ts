...
async function seed() {
  ...
  const stagesData = [
    {
      slug: 'resume-ready',
      name: 'Resume Ready',
      description: 'Build your portfolio and craft compelling resume bullet points. Complete guided projects that demonstrate real ML/AI skills.',
      weekRange: 'Week 1-2',
    ...
    },
    {
      slug: 'coding-ready',
      name: 'Coding Ready',
      description: 'Master algorithm problems and data structures. Practice LeetCode-style problems commonly asked in ML/AI interviews.',
      weekRange: 'Week 3-6',
    ...
    },
    {
      slug: 'ml-ready',
      name: 'ML Ready',
      description: 'Deep dive into ML concepts (八股文) and ML coding problems. Understand the theory and implementation details.',
      weekRange: 'Week 7-10',
    ...
    },
    {
      ...
      description: 'Learn to design ML systems at scale. Practice common ML system design interview questions.',
    ...
    },
    {
      ...
      description: 'Put it all together with mock interview sets. Build interview stamina and refine your presentation.',
      weekRange: 'Ongoing',
  ...
  const contentTypesData = [
    ...
    },
    {
      slug: 'ml_concept',
      name: 'ML Concept',
      description: 'ML concept questions (八股文) - theory and fundamentals',
    },
    {
      slug: 'ml_coding',
      name: 'ML Coding',
